# This Makefile is for the NagiosPlugins::Core extension to perl.
#
...
#     NAME => q[NagiosPlugins::Core]
#     VERSION_FROM => q[lib/NagiosPlugins/Core.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = NagiosPlugins::Core
NAME_SYM = NagiosPlugins_Core
VERSION = 1.00
...
FULLEXT = NagiosPlugins/Core
BASEEXT = Core
PARENT_NAME = NagiosPlugins
DLBASE = $(BASEEXT)
VERSION_FROM = lib/NagiosPlugins/Core.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/NagiosPlugins/Debug.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/NagiosPlugins
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/NagiosPlugins
...
TO_INST_PM = lib/NagiosPlugins/Core.pm \
	lib/NagiosPlugins/Counters.pm \
	lib/NagiosPlugins/Debug.pm \
	lib/NagiosPlugins/Objects.pm

PM_TO_BLIB = lib/NagiosPlugins/Objects.pm \
	blib/lib/NagiosPlugins/Objects.pm \
	lib/NagiosPlugins/Counters.pm \
	blib/lib/NagiosPlugins/Counters.pm \
	lib/NagiosPlugins/Debug.pm \
	blib/lib/NagiosPlugins/Debug.pm \
	lib/NagiosPlugins/Core.pm \
	blib/lib/NagiosPlugins/Core.pm
...
DISTNAME = NagiosPlugins-Core
DISTVNAME = NagiosPlugins-Core-1.00
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/NagiosPlugins/Debug.pm $(INST_MAN3DIR)/NagiosPlugins::Debug.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         NagiosPlugins-Core' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      1.00' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/NagiosPlugins/Core.pm' >> META_new.yml
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/NagiosPlugins/Objects.pm blib/lib/NagiosPlugins/Objects.pm \
	  lib/NagiosPlugins/Counters.pm blib/lib/NagiosPlugins/Counters.pm \
	  lib/NagiosPlugins/Debug.pm blib/lib/NagiosPlugins/Debug.pm \
	  lib/NagiosPlugins/Core.pm blib/lib/NagiosPlugins/Core.pm 
